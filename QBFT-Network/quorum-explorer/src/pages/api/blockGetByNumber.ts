...
export default async function handler(
  ...
  let quorumBlock: QuorumBlock = {
    ...
    number: "-1",
    hash: "",
    parentHash: "", // Tambahkan properti ini
    transactionsRoot: "",
    stateRoot: "",
    receiptsRoot: "",
    miner: "",
  ...
  try {
    ...
    quorumBlock["parentHash"] = ethBlockByNumber.data.result.parentHash; // Tambahkan ini
    ...
    quorumBlock["extraData"] = ethBlockByNumber.data.result.extraData;
